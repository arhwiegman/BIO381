...
This R markdown evaluates ggplot options for random data reflecting a block design with four treatment levels in each block. In this markdown I also build a function to plot labels from a tukey honest significant difference table. 

dataframe:

|ID | Block (B) | Treatment1 | Recipe (R) | Yield (Y)|
|---|---|---|---|
|1|1|1|1|-|
|1|1|1|2|-|
|...|...|...|...|
