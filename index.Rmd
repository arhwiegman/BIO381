...
[`stringr` lesson](stringr_lesson/stringr_lesson.html)
  ...
  - STATUS: incomplete,20180426
    ...
    - need to finalize data sources and code examples
...
[Homework 9](Homework/homework09.html): Improved functional programing 

  - STATUS: incomplete,20180426
  
    - bug in plotting and multiple regression function
    
[Homework 10](Homework/homework10.html): Batch processing of files

[Homework 11](Homework/homework11.html): Visualizing mathematical models

  - STATUS: incomplete,20180426
  
    - Need to finalize plotting function 
