...
Have you ever spent hours combing over data, copying and pasting, only to import into R and still turn an ERROR? Do you work with data from online resources, externally generated/mantained datasets, dataloggers, analytical instruments, etc...?Do you work with data in text form? Would you like to conduct an reproducable and exhaustive text/web search?
