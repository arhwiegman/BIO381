...
5. Generation of a dynamic supply curve for global phosphorus fertilizer resources.
6. Theoretical framework for optimization of organics recycling systems.

## Complex data studies

1. Modeling net energy and material flow in combined bioenergy and phosphorus recovery systems
2. Optimization of organics processing stations based on multiple criteria
3. Life cycle modeling of conventional fertilizer P industry and organic P fertilzer at various degrees of market penetration.
...
The potential uses of this study are to inform and constrain modeling efforts that evaluate tradeoffs between investments nutrient recovery systems. This might be practical for evaluating scale and location optimality (see section 2.1.6 for more on this). 
